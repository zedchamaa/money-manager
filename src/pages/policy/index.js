...
export default function PolicyPage() {
  return (
    <>
      <Head>
        <title>Cookies Policy | Money Manager Demo App by ZED CHAMAA</title>
        <meta
          name='description'
          content='Read the cookies policy of the money manager demo app'
        />
      </Head>
      <div className={styles.container}>
        ...
        <p>
          Our App uses Firebase, which may use cookies to provide services such
          as analytics, authentication, and storage. These cookies may collect
        ...
        <ul>
          ...
          <li>
            Storage cookies, which allow us to store data locally on your
            device.
          </li>
        </ul>
        ...
        <p>
          ...
          can usually modify your settings to decline them. However, if you
          choose to decline cookies, some features of our App may not function
          properly.
        </p>
        ...
        <p>
          ...
          immediately upon their posting on the App. If we make material changes
          to this Policy, we will notify you here that it has been updated, so
        ...
        <p>
          ...
          <Link href='mailto:dev@zedchamaa.com'>dev@zedchamaa.com</Link>.
        </p>
